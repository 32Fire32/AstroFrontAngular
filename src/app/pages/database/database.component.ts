...
export class DatabaseComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private serv: GetServicesService, private store: StoreService, private updateService: UpdateService, private jwtHelper: JwtHelperService){}
  ...
  ngOnInit() {
    ...
    this.liked = false
      ...
      .subscribe((data) =>{
          ...
          this.serv.GetSingle("https://localhost:7167/api/CelestialObject/GetSingle?id=", this.id).subscribe((data) =>{
            this.object = data;
  ...
  EditPreferences(){
    ...
    this.serv.EditPref("https://localhost:7167/api/PersonalPage/GetPreferences", {
